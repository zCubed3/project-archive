...
// Workaround because rustc kept wanting to fight me :)
pub type GLADloadproc_ptr = unsafe extern "C" fn(name : *const i8) -> Option<unsafe extern "C" fn()>;
pub type GLADloadproc = ::std::option::Option<GLADloadproc_ptr>;
