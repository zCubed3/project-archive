Shader "Opal/Misc/RainbowFresEye"
{
    Properties
    {
        _Speed ("Speed", float) = 1
        _OuterPower ("Outer Power", float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _Speed, _InnerPower, _OuterPower;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float F = saturate(pow(NDotV, _InnerPower) + pow(1 - NDotV, _OuterPower));
